...
dot_data = tree.export_graphviz(d_tree_gini, out_file= 'tree_gini.dot') 
graph = graphviz.graph_from_dot_file('tree_gini.dot') 
...
dot_data = tree.export_graphviz(d_tree_entropy, out_file= 'tree_entropy.dot') 
graph = graphviz.graph_from_dot_file('tree_entropy.dot') 
